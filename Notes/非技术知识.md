...
##### [灵宇宙 (Lingverse)](https://mp.weixin.qq.com/s/oHj1bC6RBrKFAYKZS5zbuA)

*   **公司与创始人**: 
    *   **公司**: 灵宇宙 (Lingverse)
    *   **创始人**: 顾嘉唯，前微软、百度人机交互研究员，拥有丰富的AI硬件创业经验（上一家公司产品为“Luka”绘本阅读机器人）。

*   **产品与定位**
    *   **当前产品**: “小方机”，一款手掌大小、带摄像头的智能交互设备，定位为“**新一代的步步高**”。
    *   **核心痛点**: 满足家长希望孩子接触AI，但又担心其沉迷于通用大模型APP（如豆包）或短视频的焦虑。小方机提供了一个**没有游戏和短视频的专属AI智能终端**。
    *   **终极愿景**: 小方机是通往“**哆啦A梦**”式家庭陪伴机器人的过渡产品和数据入口。其核心是AI操作系统，而非硬件本身。

*   **技术与数据壁垒**
    *   **核心优势**: 源于上一代产品“Luka”积累的**250亿条儿童与绘本的真实交互数据**。
    *   **数据价值**:
        1.  **提升交互体验**: 这些结构化、有标注的多模态数据（图文、点读、语音）训练了前期的小模型，使得小方机能快速推理用户意图，实现流畅响应。
        2.  **构建RAG知识库**: 积累的绘本、教培知识库确保了教育相关内容输出的准确性，减少“幻觉”。
    *   **数据飞轮**: 小方机的摄像头在日常使用中，持续收集**儿童第一视角的物理世界交互数据**，这是当前具身智能发展的最大瓶颈。这些海量真实数据将用于训练未来的“哆啦A梦”机器人。

##### [跃然创新 (Haivivi)](https://xueqiu.com/1786904335/348738612)

*   **公司与创始人**:
    *   **公司**: 跃然创新 (Haivivi)
    *   **创始人**: 李勇，消费硬件行业20年连续创业者，曾参与天猫精灵从0到3000万销量的全过程。

*   **产品迭代与策略**:
    *   **一代产品 (BubblePal)**: 挂在毛绒玩具上的对话硬件，累计销量超20万台，成功验证了产品市场匹配度 (PMF)。
        *   **痛点**: 交互（长按唤醒）和连接（依赖App和2.4G WiFi）不便。
    *   **二代产品 (CocoMate)**: 硬件直接嵌入可拆卸的毛绒玩具本体。
        *   **交互升级**: “摇一摇”即可唤醒/关闭，交互更简单。
        *   **连接升级**: 内置4G通信模组，摆脱室内WiFi限制，支持户外场景。
        *   **技术亮点**: 采用**端到端语音模型**，允许用户随时打断AI，实现更自然的对话。并设计了“音轨浮现机制”来处理故事中的提问，无缝衔接。

*   **IP与市场策略**:
    *   **IP生态**: 已获得奥特曼、小猪佩奇、奶龙等知名IP授权，同时签约艺术家开发自研IP。
    *   **市场拓展**: 在儿童玩具之外，正探索**成人陪伴玩具**市场，计划年内推出首款面向成年人的AI陪伴产品。
...
* 当AI助手在执行长期任务（如下载大模型、安装依赖、执行脚本）时，应该主动、定期检查任务进度，并向用户报告，而不是等待用户询问。
