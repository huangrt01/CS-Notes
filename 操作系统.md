...
- [操作系统（本科课程笔记）](#------------)
  ...
  * [chpt2 进程与线程](#chpt2------)
    + [1.进程](#1--)
      - [e.g. Linux进程控制块](#eg-linux-----)
      - [进程的状态](#-----)
    + [2.进程控制](#2----)
      - [e.g. POSIX进程控制](#eg-posix----)
      - [e.g. Linux进程控制](#eg-linux----)
      - [e.g. Windows进程控制](#eg-windows----)
    + [3.线程模型](#3----)
    + [4.线程的实现机制](#4-------)
      - [用户级线程（ULT）](#------ult-)
      - [内核级线程（KLT）](#------klt-)
      - [混合实现](#----)
    + [4.Windows的线程](#4windows---)
    + [5.POSIX线程](#5posix--)
    + [6.Linux的线程](#6linux---)
    + [7.进程间通信（IPC）问题概述](#7------ipc-----)
    + [8.互斥问题的几种算法](#8---------)
      - [禁止中断](#----)
      - [共享锁变量](#-----)
      - [严格轮转法](#-----)
    ...
    + [12.经典IPC问题](#12--ipc--)
      ...
      - [读者-写者问题](#-------)
      - [睡眠理发师问题](#-------)
    + [13.Windows的互斥和同步机制](#13windows--------)
    + [14.POSIX的互斥和同步机制](#14posix--------)
      - [互斥锁](#---)
      - [条件变量](#----)
      - [信号量](#---)
    + [14.Linux的进程间通信](#14linux------)
      - [信号：通知异步事件，软中断](#-------------)
      - [管道(pipe)](#---pipe-)
      - [UNIX System V：消息队列、信号量、共享内存](#unix-system-v--------------)
    + [15.Windows的进程间通信](#15windows------)
    + [16.死锁](#16--)
    + [17.处理机调度](#17-----)
    + [18.批处理系统中的调度](#18---------)
    + [19.交互式系统中的调度](#19---------)
